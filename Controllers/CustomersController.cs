        ...
        public async Task<ActionResult<Customer>> PostCustomer(CustomerDto customer)
        {
          if (_context.Customers == null)
          {
            ...
            _context.Customers.Add(new Customer { 
                ...
                //Authenification = _context.Authentifications.FirstOrDefault(a => a.CustomerId == _context.Customers.Last().CustomerId+1)
                });
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCustomer", _context.Customers.OrderBy(c => c.CustomerId).Select(c => c.CustomerId).Last(), customer);
        }
